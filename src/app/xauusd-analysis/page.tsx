...
const analysisFramework = [
  {
    ...
    title: "Price Action",
    desc: "Studying raw price movement on the chart without relying on indicators. Traders examine candlestick formations, the size and shape of recent candles, wicks (shadows) that show rejection at certain levels, and the overall pace of price movement. Price action analysis helps traders understand where buyers and sellers have been most active and whether momentum is shifting in either direction.",
  },
  {
...
const riskTopics = [
  ...
  },
  {
    ...
    desc: "Calculate your position size based on the distance to your stop-loss and the percentage of your account you are willing to risk. Many experienced traders risk only a small fraction of their total capital on any single trade.",
  },
  {
