...
const distinctions: DistinctionItem[] = [
  { title: "Lot Size", desc: "Lot size is the unit of volume you select when placing a trade through your broker's platform. It is the input you provide, and its meaning depends on what your broker defines as one lot. Two brokers may both use the label &ldquo;1.00 lot&rdquo; but represent different actual exposures if their contract sizes differ.", icon: <SquareStack className="w-6 h-6 text-trading-gold" /> },
...
const commonMistakes = [
  { title: "Choosing Lot Size Before Defining Risk", desc: "Some traders pick a lot size based on what &ldquo;feels right&rdquo; or what they can afford the margin for, then place a stop-loss afterward. The correct process is the opposite: define your maximum risk, set your stop based on the market structure, then calculate the lot size that fits those parameters.", icon: <XCircle className="w-6 h-6 text-trading-red" /> },
        ...
        <FadeSection className="py-20 md:py-28 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-base md:text-lg text-muted-foreground leading-relaxed">
              ...
              <p>Understanding these three concepts together is essential for calculating lot size accurately. If you do not know your broker's tick size and tick value, you cannot accurately determine how much money a given stop distance represents, which means you cannot accurately calculate your position size.</p>
              <div className="glass rounded-2xl p-5 border border-trading-red/30">
